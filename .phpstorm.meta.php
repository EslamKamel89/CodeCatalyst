...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\windows\my_projects\CodeCatalyst\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\windows\\my_projects\\CodeCatalyst\\public\\storage',
...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','markdown.code_highlighting.enabled','markdown.code_highlighting.theme',
'markdown.add_anchors_to_headings','markdown.render_anchors_as_links','markdown.commonmark_options','markdown.cache_store','markdown.cache_duration',
'markdown.renderer_class','markdown.extensions','markdown.block_renderers','markdown.inline_renderers','markdown.inline_parsers',
...
'debugbar.queries.explain','sanctum.csrf-cookie','home','discussions.show',
'markdown','discussions.store','discussions.delete','profile.edit','profile.update',
'profile.destroy','posts.store','posts.edit','posts.delete','register','login','password.request','password.email',
...
'laravel-exceptions::minimal','markdown::markdown','notifications::email','pagination::bootstrap-4','pagination::bootstrap-5',
